...
/**
 * Checkout form: collects email + amount, asks the backend to open a
 * Paystack transaction, then redirects the customer to Paystack's
 * hosted payment page to enter card/mobile-money details.
 *
 * The Paystack secret key never touches this component — the backend
 * holds it and only ever hands back a one-time authorization_url.
 */
