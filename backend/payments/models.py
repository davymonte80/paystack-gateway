...
class Transaction(models.Model):
    ...
    display_amount = models.DecimalField(max_digits=12, decimal_places=2, null=True, blank=True)
    display_currency = models.CharField(max_length=3, blank=True)
    exchange_rate = models.DecimalField(max_digits=16, decimal_places=6, null=True, blank=True)
